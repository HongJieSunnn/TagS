...
namespace TagS.ApplicationInterface.Configurations
{
        ...
        where TReferrerId : IEquatable<TReferrerId>
    {
        ...
        )
        {
            ...
            _tagSConfiguration.TagMongoDBContextConfigurationBuilder= tagMongoDBContextConfigurationAction;
            _tagSConfiguration.TagReferrerMongoDBContextConfigurationBuilder = tagReferrerMongoDBContextConfigurationAction;
